...
public class Situacao3Activity extends AppCompatActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_situacao3);
    }
    ...
    public void certo(View v) {
        ...
        View popupView = inflater.inflate(R.layout.activity_pop_social1, null);
        ...
        btnproximo1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Situacao3Activity.this, Situacao4Activity.class);
    ...
    public void errado(View v) {
        ...
        Intent intent = new Intent(this, Game4OverActivity.class);
        startActivity(intent);
    }
