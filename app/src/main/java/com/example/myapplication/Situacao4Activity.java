...
public class Situacao4Activity extends AppCompatActivity {
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_situacao4);
    }
    ...
    public void certo(View v) {
        ...
        btnproximo1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Situacao4Activity.this, Game4WinActivity.class);
