...
public class Situacao2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_situacao2);
    }
    ...
    public void certo(View v) {
        ...
        btnproximo1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Situacao2Activity.this, Situacao3Activity.class);
