...
public class Situacao1Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_situacao1);
    }
    ...
    public void certo(View v) {
        ...
        btnproximo1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Situacao1Activity.this, Situacao2Activity.class);
